...
// CREATE
.post(isLoggedIn, upload.array('images'), validateCampground, catchAsync(campgrounds.postNew))
...
// UPDATE
.put(isLoggedIn, isCampUser, upload.array('images'), validateCampground, catchAsync(campgrounds.update))
// DELETE
